...
namespace sdk
{
	...
	public:
		...
		virtual const sdk::vector& obb_mins( ) const = 0;
		virtual const sdk::vector& obb_maxs( ) const = 0;
		...
		virtual void world_space_trigger_bounds( sdk::vector* p_vec_world_mins, sdk::vector* p_vec_world_maxs ) const = 0;
		...
		virtual const sdk::vector& get_collision_origin( ) const             = 0;
		virtual const sdk::vector& get_collision_angles( ) const             = 0;
		virtual const sdk::matrix_3x4& collision_to_world_transform( ) const = 0;
		...
		virtual void world_space_surrounding_bounds( sdk::vector* p_vec_mins, sdk::vector* p_vec_maxs ) = 0;
		...
		virtual const sdk::matrix_3x4* get_root_parent_to_world_transform( ) const = 0;
