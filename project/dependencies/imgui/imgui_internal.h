...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildEx( const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags, bool show_text = true );
   ...
   // IMGUI_API bool          BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags);
    ...
    inline bool     FocusableItemRegister(ImGuiWindow* window, ImGuiID id) { return true; } // -> pass ImGuiItemAddFlags_Inputable flag to ItemAdd()
